...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x71C1C47Ff1EEA9908F89b0e8ed5e4DC9da12e11B),        // populate with deployed spell if deployed
            deployed_spell_created:         1651170138,        // use tx=<deploy tx> make deploy-stamp
