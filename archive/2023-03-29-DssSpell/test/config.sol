...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xE46f3Be32984F4a09619b97930EdFf04d743B319),     // populate with deployed spell if deployed
            deployed_spell_created:         1680033720,     // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           8734426,        // use `make deploy-info tx=<deployment-tx>` to obtain the block number
