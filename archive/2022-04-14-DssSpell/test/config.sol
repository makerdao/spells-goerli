...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x1dA8DD3A719f6A8C86353C5800372dEB68407e52),        // populate with deployed spell if deployed
            deployed_spell_created:         1649977086,        // use tx=<deploy tx> make deploy-stamp
