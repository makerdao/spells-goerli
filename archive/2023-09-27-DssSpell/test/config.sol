...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x7E71a341950209FA347af17aB32eef096Fd7f734), // populate with deployed spell if deployed
            deployed_spell_created: 1695767424,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   9765023,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
