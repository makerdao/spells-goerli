...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x66d28b4d8Da961D43cc030dD64b715A403e571bf),        // populate with deployed spell if deployed
            deployed_spell_created:         1649341746,        // use tx=<deploy tx> make deploy-stamp
