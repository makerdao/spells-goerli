...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x6682133cCFbc8f87da51904d95241d243f7260Bf),        // populate with deployed spell if deployed
            deployed_spell_created:         1659738690,                 // use tx=<deploy tx> make deploy-stamp
