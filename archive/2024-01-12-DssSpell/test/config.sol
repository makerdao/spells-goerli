...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x068E562b5697B7fa4aF432a9231C83D71A1815dA), // populate with deployed spell if deployed
            deployed_spell_created: 1704996936, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   10358343,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
        ...
        afterSpell.collaterals["ETH-A"] = CollateralValues({
            ...
            offboarding:  false            // If mat is being offboardinged
        });
