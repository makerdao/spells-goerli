...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x354C929eEDA2Ef5e2556736b44ed0465Ca99E029), // populate with deployed spell if deployed
            deployed_spell_created: 1701091860,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   10116277,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
