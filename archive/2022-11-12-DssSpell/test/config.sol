...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x1c2B41B3A38F52c3b8939Ef9223765cAb39CbcCE),        // populate with deployed spell if deployed
            deployed_spell_created:         1668276312,        // use `./scripts/get-created-timestamp.sh <deployment-tx>`
