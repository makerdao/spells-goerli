...
contract GoerliDssSpellTestBase is Config, DSTest, DSMath {
    ...
    function setUp() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xF614Bc4Ec72eC9866f3de2248E91bcC8243Cb94B),        // populate with deployed spell if deployed
            deployed_spell_created:         1642187279,        // use get-created-timestamp.sh if deployed
