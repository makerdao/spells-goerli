...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xd50f64f27A9709e330a0e5AfB17BA0042a4295bF),        // populate with deployed spell if deployed
            deployed_spell_created:         1652711474,        // use tx=<deploy tx> make deploy-stamp
