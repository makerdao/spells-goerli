...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x28a77AaC2dD07726D5e0Bae7bF58c61Fc1DC2e67),        // populate with deployed spell if deployed
            deployed_spell_created:         1662989352,                 // use tx=<deploy tx> make deploy-stamp
