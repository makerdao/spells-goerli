...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xA7C088AAD64512Eff242901E33a516f2381b8823),        // populate with deployed spell if deployed
            deployed_spell_created:         1661864580,                 // use tx=<deploy tx> make deploy-stamp
