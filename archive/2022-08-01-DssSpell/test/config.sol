...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x39A89D383822606Bb56138A2816Ea5f6e7c95EbE),        // populate with deployed spell if deployed
            deployed_spell_created:         1659382483,                 // use tx=<deploy tx> make deploy-stamp
