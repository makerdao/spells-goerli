...
contract DssSpellTest is DSTest, DSMath {
    ...
    function setUp() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xA74264747193C31E54652FD55B5592bE36f6380d),        // populate with deployed spell if deployed
            deployed_spell_created:         1631119560,                 // use get-created-timestamp.sh if deployed
    ...
    function isWard(address addr_, address user) internal returns (bool) {
        return AuthLike(addr_).wards(user) == 1;
    }
}
