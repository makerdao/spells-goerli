...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xe7121A8eA42d24a684b014e3944E7dF997821933), // populate with deployed spell if deployed
            deployed_spell_created: 1698747720,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   9962156,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
