...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x423DBa410C9d51fae8C34aFF803fbe1a356845dD), // populate with deployed spell if deployed
            deployed_spell_created:         1689010572,                                          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           9323371,                                             // use `make deploy-info tx=<deployment-tx>` to obtain the block number
