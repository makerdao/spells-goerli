...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xa081D85fB35df6a378C42D8fb882e7c3cA2433f8),     // populate with deployed spell if deployed
            deployed_spell_created:         1682435784,              // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           8889844,              // use `make deploy-info tx=<deployment-tx>` to obtain the block number
