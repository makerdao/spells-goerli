...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xBA41b8F1fB8861a6cF2a26fc9abFe43adCc42fCD),     // populate with deployed spell if deployed
            deployed_spell_created:         1684141080,              // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           9003383,              // use `make deploy-info tx=<deployment-tx>` to obtain the block number
