...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x4Ca8451B5a598aba0160F35505402fad9713fb0c),     // populate with deployed spell if deployed
            deployed_spell_created:         1691061516,              // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           9455398,              // use `make deploy-info tx=<deployment-tx>` to obtain the block number
