...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x8a1Ce92FebE0Dc2a932f139ed04cE4c4a43Ae109), // populate with deployed spell if deployed
            deployed_spell_created: 1706021268, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   10421111,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
