...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xa9B4aaD52db85FFdc4963D514e94720E44965499),     // populate with deployed spell if deployed
            deployed_spell_created:         1680894204,     // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           8791048,        // use `make deploy-info tx=<deployment-tx>` to obtain the block number
