...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x6e44E3024A3a04E39FF5EF9Cda05890bE3505dB5), // populate with deployed spell if deployed
            deployed_spell_created: 1695903348,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   9773853,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
