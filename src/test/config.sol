...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x79bCfde936198407b026f432714b03a0DC12368a),     // populate with deployed spell if deployed
            deployed_spell_created:         1670953596,              // use `./scripts/get-created-timestamp.sh <deployment-tx>`
