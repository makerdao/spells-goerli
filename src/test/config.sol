...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x60115cd5AE6d08908f675b36062a8EFc01c73116),     // populate with deployed spell if deployed
            deployed_spell_created:         1692969336,              // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           9578447,              // use `make deploy-info tx=<deployment-tx>` to obtain the block number
