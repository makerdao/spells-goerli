...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x497fe13A5f800b647966F63F3c8BEEA4dc83C41c),     // populate with deployed spell if deployed
            deployed_spell_created:         1669769256,     // use `./scripts/get-created-timestamp.sh <deployment-tx>`
