...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x15c263fda6Cb175878d523aCc095be6f1bCe1509),     // populate with deployed spell if deployed
            deployed_spell_created:         1670448300,              // use `./scripts/get-created-timestamp.sh <deployment-tx>`
        ...
        afterSpell = SystemValues({
            ...
            ilk_count:             60                       // Num expected in system
        });
