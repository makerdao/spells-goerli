...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x1333c68ef7736988aC39477b7e54A7844f355fbf), // populate with deployed spell if deployed
            deployed_spell_created:         1687383792,                                          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           9217669,                                             // use `make deploy-info tx=<deployment-tx>` to obtain the block number
