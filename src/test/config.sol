...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x4c8f3263f1b83095C1D49FFde9e359650E076f76),        // populate with deployed spell if deployed
            deployed_spell_created:         1662373860,                 // use tx=<deploy tx> make deploy-stamp
