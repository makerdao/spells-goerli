...
contract GoerliDssSpellTestBase is Config, DSTest, DSMath {
    ...
    function setUp() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xa0658d5855b09cA4FD464725258ba1bD2Eb6E9A4),        // populate with deployed spell if deployed
            deployed_spell_created:         1643320105,        // use get-created-timestamp.sh if deployed
