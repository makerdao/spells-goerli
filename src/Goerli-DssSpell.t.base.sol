...
contract GoerliDssSpellTestBase is Config, DSTest, DSMath {
    ...
    function setUp() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x7E8D8a08D84dBE33e8C57dFB81e7779a3Cc55637),        // populate with deployed spell if deployed
            deployed_spell_created:         1642706079,        // use get-created-timestamp.sh if deployed
