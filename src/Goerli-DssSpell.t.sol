...
contract DssSpellTest is DSTest, DSMath {
    ...
    function setUp() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xe5e806245Cd519A5b3815Fe17C03a5793d2F6f10),        // populate with deployed spell if deployed
            deployed_spell_created:         1633711457,        // use get-created-timestamp.sh if deployed
