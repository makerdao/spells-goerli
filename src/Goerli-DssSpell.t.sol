...
contract DssSpellTest is DSTest, DSMath {
    ...
    function setUp() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x8a9dF6bdC26dDde6e39AE7d4757218E38A9626AD),        // populate with deployed spell if deployed
            deployed_spell_created:         1635413630,        // use get-created-timestamp.sh if deployed
