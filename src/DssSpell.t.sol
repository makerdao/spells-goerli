...
contract DssSpellTest is DssSpellTestBase {
    ...
    function testRWA015_A_SPELL_OPERATOR_WIPE_FREE() public {
        ...
        GodMode.setBalance(address(psmGem), RWA015_A_CUSTODY, daiToPay / daiPsmGemDiffDecimals);
        ...
        // Note: for Görli we also need to increase the global and PSM-USDC-A debt ceilings
        GodMode.setWard(address(vat), address(this), 1);
